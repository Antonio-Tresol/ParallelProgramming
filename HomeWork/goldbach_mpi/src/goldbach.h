...
/**
  ...
  * be used
  */
void Atkin_sieve(bool* sieve, int64_t limit);
/**
 * @brief finds the prime numbers between 2 and n
 * 
 * @param sieve is an array of booleans to fill with the sieve
 * @param limit is the maximum number to find the primes
 */
void SieveOfEratosthenes(bool* sieve, int64_t limit);
/**
...
* @param start the start of the work unit
* @param finish the end of the work unit
*/
void compute_goldbach(shared_mem_t* mem, int64_t thread_count, int64_t start,
  int64_t finish);
/**
