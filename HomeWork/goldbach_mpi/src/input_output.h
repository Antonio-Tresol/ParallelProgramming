 ...
 * @details it prints the number, the number of sums and the sums
 * @param array_of_nodes the array of nodes to print
 * @param begin the index of the first node to print
 * @param end the index of the last node to print
 */
void print_goldbach_sums_block(array_of_nodes_t* array_of_nodes, int64_t begin,
                               int64_t end);
