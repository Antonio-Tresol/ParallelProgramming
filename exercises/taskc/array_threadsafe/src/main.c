...
void test_arrays(array_mutex_t* array1, array_mutex_t* array2);
void* test_array(void* data);

int main() {
    array_mutex_t* array1 = array_create(100);
    array_mutex_t* array2 = array_create(100);
...
void* test_array(void* data) {
    array_mutex_t* array = (array_mutex_t*)data;
